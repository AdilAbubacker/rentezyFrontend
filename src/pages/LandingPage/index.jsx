    ...
    <>
      <div className="bg-white-A700 flex flex-col font-markoone sm:gap-10 md:gap-10 gap-[100px] items-center justify-start mx-auto w-auto sm:w-full md:w-full">
        <div className="flex flex-col items-start justify-start w-full">
          <LandingPageHeader className="bg-yellow-50 flex gap-2 h-20 md:h-auto items-center justify-between md:px-5 px-[120px] py-[19px] w-full" />
                    ...
                    <div className="flex gap-6 items-start justify-start w-full">
                      <div className="flex flex-col gap-5 items-start justify-start w-full">
                        <Input
                          ...
                          className="font-semibold p-0 pl-2 placeholder:text-gray-600 text-gray-600 text-left text-lg w-full"
                          wrapClassName="bg-white-A700 flex pb-3.5 pt-5 px-4 rounded-[60px] w-full"
                          onChange={(value) => setSearchQuery(value)}
                          prefix={
                            <Img
                              className="mt-auto mb-[5px] h-5/6 l-[15px]"
                      ...
                      <Button 
                      className="bg-gray-900 cursor-pointer font-bold py-[17px] rounded-[60px] text-center text-lg text-white-A700 w-full"
