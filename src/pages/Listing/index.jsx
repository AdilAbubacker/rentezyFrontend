            ...
            <div className="flex flex-col gap-6 items-center justify-center max-w-[1200px] mx-auto w-full">
              ...
              <div className="flex flex-col gap-3 items-start justify-start w-full">
                ...
                <div className="flex flex-row flex-wrap gap-2.5 items-start justify-start max-w-[1200px] w-full">
                  ...
                  <div className="border border-bluegray-101 border-solid font-semibold text-gray-700 text-left text-smcursor-pointer flex items-center justify-center min-w-[243px] px-[13px] py-2 rounded-[10px]">
                      Square Feet
                  </div>
                  <Button
