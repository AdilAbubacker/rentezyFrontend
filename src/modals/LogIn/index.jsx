...
const LogInModal = (props) => {
  ...
  return (
    <ModalProvider
      ...
      {...props}
    >
      <div className="sm:h-auto md:h-auto max-h-[95vh] overflow-y-auto sm:w-full md:w-full">
        <div className="bg-white-A700 border border-bluegray-100 border-solid flex flex-col items-start justify-start md:px-5 px-[30px] py-10 rounded-[5px] w-full">
          <div className="flex flex-col gap-8 items-center justify-center w-full">
            ...
            <div className="flex flex-col gap-[18px] items-start justify-start w-full">
              ...
              <Button
                className="common-pointer bg-white-A700 border border-gray-600 border-solid cursor-pointer flex items-center justify-center w-full min-w-[420px] sm:min-w-full px-[34px] py-[17px] rounded-[10px]"
